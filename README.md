# Devskiller programming task sample - Chef
...
This repo contains a sample project for Chef and below you can
...
Every cookbook in your project will be tested with the following commands:
...
**When you will be creating a ZIP archive with project contents, please skip
...
In our sample project all verification tests names are prefixed with
`Verification` string and are located in `spec` subdirectories. In this case
